    ...
    <View style={styles.homeScreen}>
      ...
      <View style={styles.addMemoriesBar}>
          ...
          <View style={styles.addMemoryOptions}>
            <Pressable style={styles.addMemoryList} onPress={() => navigation.navigate('AddVideoMemory1')} >
            ...
            <Pressable style={styles.addMemoryList} onPress={() => navigation.navigate('AddTextMemory1')} >
