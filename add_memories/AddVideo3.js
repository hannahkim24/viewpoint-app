...
export default function Location2Viewing({ navigation }) {
  return (
    <View style={styles.homeScreen}>
      ...
      <Pressable onPress={() => navigation.navigate('AddVideo3Confirm')}>
          <Image style={styles.logoIcon} source={LogoIcon}/>
      </Pressable>
      
      <View style={styles.addMemoryOptions} >
           <Text style={styles.addMemoryButtonText}>    Click a Viewpoint to pin a memory to!    </Text>
      </View>
