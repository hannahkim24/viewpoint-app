...
export default function Location3Viewing({ navigation }) {
  return (
    <View style={styles.homeScreen}>
      ...
      <Pressable onPress={() => navigation.navigate('AddTextMemory1Confirm')}>
      ...
      <View style={styles.addMemoryOptions} >
        ...
        <View style={styles.confirmation} >
          <Pressable onPress={() => navigation.navigate('AddText1Submit')}>
            <Text style={styles.addMemoryButtonText}>     Yes     |</Text>
          </Pressable>
          <Pressable onPress={() => navigation.navigate('AddTextMemory1')}>
