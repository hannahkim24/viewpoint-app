...
export default function AddVideoMemory({ route, navigation }) {
      ...
      <View style={styles.addMemoriesBar}>
        ...
        />
         ...
         <View style={styles.bottomBar}> 
          <Pressable onPress={() => navigation.navigate('AddVideo1Submit')}>
            <Text style={styles.bottomButtons}>     Record Again          |</Text>
          </Pressable>

          <Pressable onPress={() => navigation.navigate('AddVideo1Complete')}>
