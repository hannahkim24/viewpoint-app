...
import continueNav from './icons/end-nav.png';
...
export default function MapThree({ navigation }) {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Pressable  style={styles.continueNav} onPress={() => navigation.navigate('Location3Viewing')}  >
        <Text style={{color: 'white', fontSize: 16}}>  Continue Viewing Memories </Text>
      </Pressable>
