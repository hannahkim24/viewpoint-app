  ...
  return (
    <View style={styles.homeScreen}>
      ...
      <View style={styles.addMemoriesBar}>
          ...
          <Pressable onPress={() => navigation.navigate('AddMemory1')}>
          <Image style={styles.viewMemoryButtonIcons} source={AddIcon}/>
          </Pressable>
			</View>
      <View style={styles.viewMemoriesBar}>
            <Pressable style={styles.viewMemoryButtons} onPress={() => navigation.navigate('ViewVideoMemory1')}>
              <Image style={styles.viewMemoryButtonIcons} source={CameraIcon}/>
              <Text style={styles.viewMemoryButtonText}>View video memory</Text>
            </Pressable>
            <Pressable style={styles.viewMemoryButtons} onPress={() => navigation.navigate('ViewTextMemory1')}>
      ...
      <View style={styles.backButtonBar}>
        <Pressable style={styles.backButton} onPress={() => navigation.navigate('Location1Arrival')} >
